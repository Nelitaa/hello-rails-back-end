...
**Hello Rails Backend** is a backend web application that handles the API to display a random greeting message on screen using [Hello React Frontend](git@github.com:Nelitaa/hello-react-front-end.git) as front-end.
...
```
  git clone git@github.com:Nelitaa/hello-rails-back-end.git
```
